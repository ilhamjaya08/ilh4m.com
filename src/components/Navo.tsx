...
export const Navo = () => {
  ...
  return (
    <>
      <motion.button
        className="fixed top-6 right-6 w-14 h-14 bg-white rounded-full border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-50 flex items-center justify-center"
